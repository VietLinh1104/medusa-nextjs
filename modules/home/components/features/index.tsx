    ...
    <section className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
           <p className="text-[#e85a31] font-bold text-xs uppercase tracking-[0.3em] mb-4">Vì sao chọn chúng tôi</p>
           <h2 className="text-2xl font-black text-gray-900 uppercase">Chọn Mật Ong Manuka</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {features.map((feature, index) => (
            <div key={index} className="text-center group">
              ...
              <h3 className="text-sm font-black text-gray-900 uppercase mb-3 px-4">{feature.title}</h3>
              <p className="text-xs text-gray-500 leading-relaxed px-6">{feature.desc}</p>
            </div>
          ))}
        </div>
      </div>
